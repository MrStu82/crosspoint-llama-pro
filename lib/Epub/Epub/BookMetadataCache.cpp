...
namespace {
constexpr uint8_t BOOK_CACHE_VERSION = 11;  // v11: retain canonical ISBN metadata
...
bool BookMetadataCache::buildBookBin(const std::string& epubPath, const BookMetadata& metadata) {
  ...
  serialization::writeString(bookOut, metadata.isbn);
...
bool BookMetadataCache::load() {
  ...
  serialization::readString(bookFile, coreMetadata.isbn);
