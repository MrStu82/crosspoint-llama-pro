...
typedef struct {
  ...
  /// Split form of the class maps, used by newly generated built-in fonts. These fields live at
  /// the end so existing fork-only generated headers remain aggregate-compatible and keep their
  /// packed/dense kerning representation until they are regenerated by their official source path.
  ...
  /// Sparse (CSR) kerning for generated built-ins. The dense matrix remains byte-for-byte
  /// supported for SD-card fonts and legacy fork-only built-ins.
